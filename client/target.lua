...
CreateThread(function()
	...
	--AddModelTargetZone('stealdiethylamide', { { modelHash = 344662182 } }, {event = "md-drugs:client:getdiethylamide",	label = "stealing Diethylamide"}) -- lsd
	...
	--AddModelTargetZone('stealdiethylamide', {event = "md-drugs:client:getdiethylamide", icon = "fas fa-sign-in-alt", label = "Stealing Diethylamide"})
end)
