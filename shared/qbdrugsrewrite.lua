...
QBConfig.DrugsPrice = {
    -- base qb
    ["weed_white-widow"] =          {min = 150, max = 240 },
    ["weed_og-kush"] =              {min = 150, max = 280},
    ["weed_skunk"] =                {min = 150, max = 310},
    ["weed_amnesia"] =              {min = 180, max = 340},
    ["weed_purple-haze"] =          {min = 180, max = 370},
    ["weed_ak47"] =                 {min = 180, max = 400},
    ["crack_baggy"] =               {min = 250, max = 450},
    ["cokebaggy"] =                 {min = 300, max = 500},
    -- coke
    ["cokebaggystagetwo"] =         {min = 500, max = 750},
	["cokebaggystagethree"] =       {min = 750, max = 1000},
    -- heroin 
    ...
    -- LSD
	["gratefuldead_tabs"] =         {min = 350, max = 400},
	["bart_tabs"] =                 {min = 300, max = 350},
	["pineapple_tabs"] =            {min = 250, max = 300},
	["yinyang_tabs"] =              {min = 200, max = 250},
	["wildcherry_tabs"] =           {min = 150, max = 200},	
	["smiley_tabs"] =               {min = 100, max = 150},
	-- lean
...
QBConfig.DeliveryItems = {
    ...
    {    item = "coke_brick",    minrep = 25,    payout = {min = 2000, max = 2500}},
}
